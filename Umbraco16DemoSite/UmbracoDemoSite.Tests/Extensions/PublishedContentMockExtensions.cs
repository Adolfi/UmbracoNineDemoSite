...
namespace UmbracoDemoSite.Tests.Extensions
{
    public static class PublishedContentMockExtensions
    {
        ...
        public static IPublishedContent? Root(this Mock<IPublishedContent> content)
        {
            var rootContentMock = new Mock<IPublishedContent>();
            rootContentMock.SetupPropertyValue("name", "RootPage");
