...
using SearchResults = UmbracoDemoSite.Core.Features.Search.Models.SearchResults;

namespace UmbracoDemoSite.Core.Features.Search.Services
{
    public class SearchService
    {
        ...
        public SearchResults? Search(BaseSearchCriteria criteria)
        {
            ...
            if (searchResults == null || criteria.SearchTerm == null)
            { return null; }
        ...
        private SearchResults? GetProductsSearchResults(ISearchResults searchResults, string? searchTerm)
        {
            ...
            var results = new SearchResults
            {
                ...
                Results = searchResults.Any() ? searchResults.Select(x =>
